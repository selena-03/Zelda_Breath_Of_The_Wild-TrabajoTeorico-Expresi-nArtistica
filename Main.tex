...
Gran parte de la arquitectura de ZBoW está basada en un estilo gótico el cual se empleaba en el medievo, como se puede observar en la arquitectura del castillo de Hyrule. No obstante, en cuanto hablamos de la arquitectura Sheikah esta proviene de un estilo totalmente distinto, está inspirada en el estilo prehistórico de la cultura Jomon, de Japón. Con esto, se tiene en mente dar un toque no solo de misticismo y antigüedad sino también avanzado tecnológicamente.
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.4]{general images/arquitectura-gotica-imagenes.jpg}
      \caption{\small Comparación en la vida real}
    \end{figure}

        \begin{figure}[H]
      \centering
      \includegraphics[scale=0.17]{general images/castillo hyrule.jpg}
...
Zelda Breath of the Wild utiliza el método de sombreado plano o mejor conocido como “cel shading”, el cual consiste en un tipo de renderización que tiene como objetivo hacer que los gráficos posean un estilo parecido a los dibujos hechos a mano. Esta técnica proviene de la animación tradicional, antes de la llegada de los métodos digitales, teniendo como resultado un estilo artístico realista en la iluminación y escenarios pero un estilo orientado más a la utilizada en la animación japonesa en cuanto se refiere a los personajes, en concreto, el estilo de Breath of the wild recuerda al estilo artístico empleado en las películas de studio Ghibli.
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=2]{general images/celshading.jpg}
      \caption{\small Cel-shading primer ejemplo}
    \end{figure}

        \begin{figure}[H]
      \centering
      \includegraphics[scale=0.4]{general images/celshading2.jpg}
...
%-----------------------------------------------------------------
    ...
    \subsection{5. Miquel}
        \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/5_concept_art.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/vista1.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/puntosdefuga1.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/1regla23png.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/puntosinteres1.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/flechas1.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/leydelabalanza1.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/imagen-claroscuro.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/imagen-luminosidad.png}
   ...
   \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/imagen-clave.png}
...
Como resultado de lo anteriormente dicho, podemos decir que esta imagen es de clave alta, ya que presenta mucha iluminación.
 ...
 \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/imagen-colores.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/imagen-gamas.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/imagen-contrastes.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección5/imagen-colorfinal.png}
...
%-----------------------------------------------------------------
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección7/7_concept_art.jpg}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección7/vista2.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección7/puntosdefuga2.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección7/2regla23.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección7/puntosdeinteres2.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección7/flechas2.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección7/leydelabalanza2.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images/Miquel/sección7/imagen2-claroscuro.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images//Miquel/sección7/imagen2-luminosidad.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images//Miquel/sección7/imagen2-clave.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images//Miquel/sección7/imagen2-colores.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images//Miquel/sección7/imagen2-gamas.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images//Miquel/sección7/imagen2-contrastes.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.1]{images//Miquel/sección7/imagen2-final.png}
...
%-----------------------------------------------------------------
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale=0.35]{images/Selena/14 puntos de interesx.jpg}
